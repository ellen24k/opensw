                    ...
                    <TableRow>
                        ...
                        {Object.values(row)[0].map((course, idx_course) => {
                            if (course == "") {
                                ...
                                return <TableCell align="top" sx={{ padding: "2px", backgroundColor: "blue", color: "white", fontSize: "12px", width: "14%", border: "1px solid gray" }} rowSpan={2 * (course.end - course.start + 0.5)}>
