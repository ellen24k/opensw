                    ...
                    <TableRow>
                        ...
                        {Object.values(row)[0].map((course, idx_course) => {
                            if (course == "") {
                                ...
                                return <TableCell sx={{ padding: "4px", backgroundColor: "blue", color: "white", fontSize: "12px", width: "14%", border: "1px solid gray", verticalAlign: "top" }} rowSpan={2 * (course.end - course.start + 0.5)}>
